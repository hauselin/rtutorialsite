...
This is how my directories/folders/files look like. You should make sure yours look identical before you continue.

— analysis.Rmd (in currenct working directory)
...
dt1 <- lapply(files, fread) %>% bind_rows() %>% tbl_dt() # read data and convert to data.table and tibble
```
