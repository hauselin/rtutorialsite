---
title: "Reshape multi-dimensional arrays in Python numpy"
description: |
  The only tutorial you'll need to understand how Python numpy reshapes multidimensional arrays
...
Get source code for this RMarkdown script [here](https://github.com/hauselin/rtutorialsite/blob/master/_posts/2019-12-20-numpy-reshape/numpy-reshape.Rmd). Download the cheatsheet [here](https://github.com/hauselin/rtutorialsite/raw/master/_posts/2019-12-20-numpy-reshape/reshape.pdf).
...
If you want to let numpy automatically determine what size/length of the a particular dimension should be, specify the dimension as -1 for that dimension.
...
## Convert/flatten/ravel to 1D arrays with ravel()
...
Create two separate 3 by 4 arrays.
...
### Create a 3D array by stacking the arrays along different dimensions
