...
# draft: false
repository_url: ./neural-networks-deriving-the-sigmoid-derivative.Rmd
editor_options: 
...
Get source code for this RMarkdown script [here](./neural-networks-deriving-the-sigmoid-derivative.Rmd).
