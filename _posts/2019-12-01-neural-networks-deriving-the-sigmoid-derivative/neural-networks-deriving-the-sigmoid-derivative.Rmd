...
# draft: false
repository_url: https://github.com/hauselin/rtutorialsite/blob/master/_posts/2019-04-13-logistic-regression/logistic-regression.Rmd
editor_options: 
...
Get source code for this RMarkdown script [here](http://www.google.com).
